...
public class IosCaseBuilder {


    public IOSDriver<MobileElement> driver;
    public WebDriverWait wait;

    public IosCaseBuilder(IOSDriver<MobileElement> driver){
        this.driver = driver;
    ...
    void pressHomeButton(int duration_sec){
        driver.runAppInBackground(Duration.ofSeconds(duration_sec));
